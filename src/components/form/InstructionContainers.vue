<script setup>
import { layout, makeDefaultEntity } from '@/config/forms/shipment/InstructionContainers';
...
function onUpdate() {
  ...
  if(lastElement.type === null
    && lastElement.containerNumber === null
    && lastElement.sealNumber === null
    && lastElement.grossWeight === null
    && lastElement.cbm === null
    && lastElement.tare === null
    && lastElement.packageType === null
    && lastElement.packageCount === null
    && lastElement.note === null
    && lastElement.method === null
  ) {
