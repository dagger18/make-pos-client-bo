<script setup>
import { layout, makeDefaultEntity } from '@/config/forms/shipment/InstructionCharges';
...
function onUpdate() {
  ...
  if(lastElement.charges === null
    && lastElement.unit === null
    && lastElement.quantity === null
    && lastElement.currency === null
    && lastElement.exRate === null
    && lastElement.rate === null
    && lastElement.tax === null
    && lastElement.amount === null
  ) {
