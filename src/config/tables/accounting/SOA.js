...
import { findByValue as findEbitNoteTypeByValue } from '@/config/enums/EbitNoteType';
...
export const headers = () => {
  ...
  return [
    ...
    { 
      key: 'shipment.masterBill', 
      text: $gettext('Master Bill')
    },
    { 
      key: 'shipment.houseBill', 
      text: $gettext('House Bill')
    },
    { 
      key: 'shipment.code', 
    ...
    { 
      ...
      text: $gettext('Type'),
      renderObject (item) {
        return findEbitNoteTypeByValue(item.type)?.accountingMenu
      }
    },
    { 
