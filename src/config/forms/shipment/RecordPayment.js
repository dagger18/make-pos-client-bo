      ...
      [
        {
          ...
          callParams: {'isOneOf_Client_invoiceInfos': entity.payTo?.id },
          itemValue: 'id',
          itemTitle(item) {
            return item.company
          },
        ...
        },
        {
          ...
          apiEndpoint: InvoiceInfoService,
          searchOnProperties: ['company', 'email', 'contactName'],
          callParams: {'isOneOf_Provider_invoiceInfos': entity.payTo?.id },
          itemValue: 'id',
          itemTitle(item) {
            return item.company
          },
