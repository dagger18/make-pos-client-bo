...
import CommonService, { availableCurrencies, dayJSToUTC, exchangeRatesToMap } from '@/services/CommonService';
...
export const makeDefaultEntity = (context) => {
  const providerCreatedIdList = context.ebitNotes
    .filter(e => e.type === EbitNoteType.POBO)
    .map(e => e.payTo.id)
      ...
      [ 
        {
          ...
          apiEndpoint: ClientService,
          columnSpan: 3,
          show: entity.targetType2 === 'client',
          coreItems: clients,
          coreItemsGroup: $gettext('From pricing'),
          dynamicItemsGroup: $gettext('From custom'),
        },
        {
          ...
          apiEndpoint: ProviderService,
          columnSpan: 3,
          show: entity.targetType2 === 'provider',
          rowClass: {'mt-n4': true},
          coreItems: providers,
          coreItemsGroup: $gettext('From pricing'),
          dynamicItemsGroup: $gettext('From custom'),
