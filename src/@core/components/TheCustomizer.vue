...
watch([
  ...
  const initialConfigValue = [
    ...
    themeConfig.verticalNav.navTheme,
...
const resetCustomizer = async () => {
  ...
  configStore.navTheme = themeConfig.verticalNav.navTheme
    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- 👉 Nav Theme -->
          <div class="mt-4" v-if="configStore.appContentLayoutNav === AppContentLayoutNav.Vertical">
            <VLabel class="text-high-emphasis mb-1">Nav Theme</VLabel>
            <VSelect
              v-model="configStore.navTheme"
