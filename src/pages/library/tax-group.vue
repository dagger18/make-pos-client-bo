<script setup>
import { filterConfigs, headers } from '@/config/tables/library/TaxGroup';
import EntityService from '@/services/library/TaxGroupService';
import { useAppStore } from '@/stores/appStore';
import TaxGroupForm from '@/views/library/TaxGroupForm.vue';
import { useLibraryHeader } from '@/composables/useLibraryHeader';
import { useGettext } from 'vue3-gettext';
definePage({
  meta: { action: 'GET', subject: 'TaxGroup' },
})
...
const form = ref(null)
const buttons = computed(() => [{ text: $gettext('Add Tax Group'), func: form.value?.setEntity }])
