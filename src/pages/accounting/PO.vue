...
import { filterConfigs, headers } from '@/config/tables/accounting/PO';
...
definePage({ 
  meta: { action: 'MANAGE_PO', subject: 'EbitNote', navActiveLink: 'accounting-id' },
})
...
<template>
  <AppTable
    ...
    ref="table"
    :apiCallParam="{'filter_type': EbitNoteType.POBO}"
    :pageTitle="''"
  >
    <template v-slot:title>
      <AccountingTabs :modelValue="EbitNoteType.POBO" />
    </template>
    <template #code="{item}">
