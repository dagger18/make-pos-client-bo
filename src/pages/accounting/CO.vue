...
definePage({ 
  meta: { action: 'MANAGE_CO', subject: 'EbitNote', navActiveLink: 'accounting-id' },
})
...
<template>
  <AppTable
    ...
    ref="table"
    :apiCallParam="{'filter_type': EbitNoteType.COBO}"
    :pageTitle="''"
  >
    <template v-slot:title>
      <AccountingTabs :modelValue="EbitNoteType.COBO" />
    </template>
    <template #code="{item}">
