...
import { filterConfigs, headers } from '@/config/tables/accounting/PMT';
...
definePage({ 
  meta: { action: 'MANAGE_PMT', subject: 'EbitNote', navActiveLink: 'accounting-id' },
})
...
<template>
  <AppTable
    ...
    ref="table"
    :apiCallParam="{'filter_type': EbitNoteType.RecordPayment}"
    :pageTitle="''"
  >
    <template v-slot:title>
      <AccountingTabs :modelValue="EbitNoteType.RecordPayment" />
    </template>
    <template #code="{item}">
